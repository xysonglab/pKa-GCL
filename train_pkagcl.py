...
def evaluate(model, loader):
    ...
    for _ in range(loader.steps):
        ...
        feat_2d, feat_3d = model(graph_2d, graph_3d,y)
...
#python train_gcl.py --cuda 0 --dataset sxy --num_dist 4 --cut_dist 5 --model_dir './runs/sxy'
if __name__ == "__main__":
    ...
    if args.dataset in ['pkb_30000', 'bpkb_30000']:
    ...
    model = pKaGCL(node_in_dim, edge_in_dim, atom_in_dim, args.rbf_dim, args.hidden_dim, \
