...
def get_atom_features_sdf(mol, use_degree=True, use_hybridization=True, use_implicit_valence=True,
...
if __name__ == "__main__":
    ...
    if args.dataset in ['bpka_30000','pka_30000']:
        x_y_name_dict = {'dataset': ('smiles', 'pka')}
        x_y_name_dict['bpka_30000'] = ('smiles', 'bpka')
    ...
    with open(out_path, 'wb') as f:
        pickle.dump((data_mols, mol_list, logp_list), f)
